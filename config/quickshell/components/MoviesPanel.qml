            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Text { id: syncLbl; anchors.centerIn: parent
                            text: Movies.hasAccount ? "󰑐 Sync" : "󰑐 Refresh"
                        ...
                        Rectangle {
                            ...
                            RowLayout {
                                ...
                                Row { spacing: 6
                                    ...
                                    Rectangle {
                                        visible: Movies.currentItem !== null; height: 28; radius: 14
                                        property bool inWl: Movies.currentItem && (Movies.watchlistMovie.length || Movies.watchlistTv.length)
                                    ...
                                    Rectangle {
                                        visible: Movies.currentItem !== null; height: 28; radius: 14
                                        property bool inFav: Movies.currentItem && (Movies.favoritesMovie.length || Movies.favoritesTv.length)
                                    ...
                                    Rectangle {
                                        visible: Movies.currentItem !== null; height: 28; radius: 14
                                        property bool saved: Movies.currentItem && Movies.libraryList.length
