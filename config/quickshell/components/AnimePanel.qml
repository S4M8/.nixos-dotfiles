...
PanelWindow {
    ...
    property string anilistUsername: "Uprising7723"
    property bool   usernameEditing: false
    property string usernameInput:   "Uprising7723"
            ...
            Column {
                ...
                Rectangle {
                    ...
                    visible: {
                        ...
                        var _ = animePanel.statusPickerFor === "anime" ? Anime.libraryAll : Manga.libraryAll
                                    ...
                                    Rectangle { Layout.fillWidth: true; height: 46; color: Qt.rgba(0,0,0,0.3)
                                        RowLayout { anchors { fill: parent; leftMargin: 8; rightMargin: 12 } spacing: 6
                                            ...
                                            Rectangle {
                                                ...
                                                height: 28; radius: 14
                                                property string curSt: Anime.currentAnime && Anime.libraryAll ? Anime.getLibraryStatus(Anime.currentAnime.id) : ""
                                ...
                                Column { anchors.fill: parent; spacing: 0
                                    Rectangle { width: parent.width; height: 44; color: Qt.rgba(0,0,0,0.2)
                                        Rectangle {
                                            ...
                                            width: refrLbl.implicitWidth + 14; height: 24; radius: 8
                                            color: refrMa.containsMouse ? Qt.rgba(root.walColor5.r,root.walColor5.g,root.walColor5.b,0.25) : Qt.rgba(0,0,0,0.3)
                                            Text { id: refrLbl; anchors.centerIn: parent; text: "󰑐"; font.pixelSize: 11; color: root.walColor5 }
                                            MouseArea { id: refrMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
                                                onClicked: { Anime.fetchAllLibrary(); Manga.fetchAllLibrary() }
                                            }
                                        }
                                        ListView { anchors { fill: parent; leftMargin: 8; rightMargin: 44 }
                                            orientation: ListView.Horizontal; spacing: 6; clip: true
                                            boundsBehavior: Flickable.StopAtBounds
                                    ...
                                    Rectangle { Layout.fillWidth: true; height: 46; color: Qt.rgba(0,0,0,0.3)
                                        RowLayout { anchors { fill: parent; leftMargin: 8; rightMargin: 12 } spacing: 6
                                            ...
                                            Rectangle {
                                                ...
                                                property string curSt: Manga.currentManga && Manga.libraryAll ? Manga.getLibraryStatus(Manga.currentManga.id) : ""
